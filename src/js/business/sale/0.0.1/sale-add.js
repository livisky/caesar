define(function (require, exports, module) {
	...
	//end business related directives
		.controller("formController", ['$scope', '$modal', '$http', 'globalData', function ($scope, $modal, $http, globalData) {
		//metadata
		...
		$scope.submit = function () {
			if ($scope.discountForm.$valid) {
				...
				$scope.discountForm.submitted = true;
			}
		};
	}])
		.controller("modalController", ['$scope', '$modal', '$modalInstance', '$filter', 'globalData', 'data', function ($scope, $modal, $modalInstance, $filter, globalData, data) {
